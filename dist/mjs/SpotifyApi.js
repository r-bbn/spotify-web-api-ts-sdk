...
export class SpotifyApi {
    ...
    */
    ...
    static withUserAuthorization(clientId, clientSecret, redirectUri, scopes = [], config) {
        const strategy = new AuthorizationCodeWithPKCEStrategy(clientId, clientSecret, redirectUri, scopes);
    ...
    static withImplicitGrant(clientId, clientSecret, redirectUri, scopes = [], config) {
        const strategy = new ImplicitGrantStrategy(clientId, clientSecret, redirectUri, scopes);
        return new SpotifyApi(strategy, config);
    }
    /**
    ...
    static withAccessToken(clientId, clientSecret, token, config) {
        const strategy = new ProvidedAccessTokenStrategy(clientId, clientSecret, token);
        return new SpotifyApi(strategy, config);
    }
