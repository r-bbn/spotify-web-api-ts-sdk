...
export declare class SpotifyApi {
    ...
    */
     ...
     */
    logOut(): void;
    static withUserAuthorization(clientId: string, clientSecret: string, redirectUri: string, scopes?: string[], config?: SdkOptions): SpotifyApi;
    static withClientCredentials(clientId: string, clientSecret: string, scopes?: string[], config?: SdkOptions): SpotifyApi;
    static withImplicitGrant(clientId: string, clientSecret: string, redirectUri: string, scopes?: string[], config?: SdkOptions): SpotifyApi;
    /**
     ...
     */
    static withAccessToken(clientId: string, clientSecret: string, token: AccessToken, config?: SdkOptions): SpotifyApi;
    /**
     ...
     */
    static performUserAuthorization(clientId: string, clientSecret: string, redirectUri: string, scopes: string[], postbackUrl: string, config?: SdkOptions): Promise<AuthenticationResponse>;
    /**
     * Use this when you're running in the browser, and want to perform the user authorization flow to post back to your server with the access token.
     ...
     * @param config Optional configuration
     */
    static performUserAuthorization(clientId: string, clientSecret: string, redirectUri: string, scopes: string[], onAuthorization: (token: AccessToken) => Promise<void>, config?: SdkOptions): Promise<AuthenticationResponse>;
}
