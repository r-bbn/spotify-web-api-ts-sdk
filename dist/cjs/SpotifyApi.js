...
class SpotifyApi {
    ...
    */
    ...
    static withUserAuthorization(clientId, clientSecret, redirectUri, scopes = [], config) {
        const strategy = new AuthorizationCodeWithPKCEStrategy_js_1.default(clientId, clientSecret, redirectUri, scopes);
    ...
    static withImplicitGrant(clientId, clientSecret, redirectUri, scopes = [], config) {
        const strategy = new ImplicitGrantStrategy_js_1.default(clientId, clientSecret, redirectUri, scopes);
        return new SpotifyApi(strategy, config);
    }
    /**
     ...
     */
    static withAccessToken(clientId, clientSecret, token, config) {
        const strategy = new ProvidedAccessTokenStrategy_js_1.default(clientId, clientSecret, token);
        return new SpotifyApi(strategy, config);
    }
    static async performUserAuthorization(clientId, clientSecret, redirectUri, scopes, onAuthorizationOrUrl, config) {
        const strategy = new AuthorizationCodeWithPKCEStrategy_js_1.default(clientId, clientSecret, redirectUri, scopes);
