...
class AuthorizationCodeWithPKCEStrategy {
    ...
    async getOrCreateAccessToken() {
        const token = await this.cache.getOrCreate(AuthorizationCodeWithPKCEStrategy.cacheKey, async () => {
            ...
            return AccessTokenHelpers_js_1.default.refreshCachedAccessToken(this.clientId, this.clientSecret, expiring);
        });
        return token;
    }
    ...
    async redirectOrVerifyToken() {
        ...
        return IAuthStrategy_js_1.emptyAccessToken; // Redirected away at this point, just make TypeScript happy :)         
    }
    async redirectToSpotify() {
        const verifier = AccessTokenHelpers_js_1.default.generateCodeVerifier(128);
        const challenge = await AccessTokenHelpers_js_1.default.generateCodeChallenge(verifier);
...
exports.default = AuthorizationCodeWithPKCEStrategy;
