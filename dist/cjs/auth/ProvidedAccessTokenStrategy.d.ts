...
export default class ProvidedAccessTokenStrategy implements IAuthStrategy {
    ...
    constructor(clientId: string, clientSecret: string, accessToken: AccessToken, refreshTokenAction?: (clientId: string, clientSecret: string, token: AccessToken) => Promise<AccessToken>);
